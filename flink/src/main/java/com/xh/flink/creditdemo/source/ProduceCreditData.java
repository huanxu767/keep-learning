...
import com.xh.flink.creditdemo.source.CreditApplySource;
 ...
 */
public class ProduceCreditData {
...
//        ));
        DataStreamSource<String> dataStreamSource = env.addSource(new CreditApplySource()).setParallelism(1);
        FlinkKafkaProducer myProducer = new FlinkKafkaProducer(CreditConfig.BOOTSTRAP_SERVERS, CreditConfig.CREDIT_APPLY_TOPIC,new SimpleStringSchema());
